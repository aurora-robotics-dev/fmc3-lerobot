...
DATASET_ROOT="${DATASET_ROOT:-/home/phl/workspace/dataset/fourier/gr2/muticams/lerobot/fmc3_gr2_black_capped_bottle_yellow_to_green_lerobot}"
DATASET_REPO_ID="${DATASET_REPO_ID:-local/fmc3_gr2_black_capped_bottle_yellow_to_green_lerobot}"
POLICY_PATH="${POLICY_PATH:-/home/phl/workspace/models/pi0}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/phl/workspace/mymodels/gr2/pi0_gr2_black_capped_bottle_yellow_to_green}"
JOB_NAME="${JOB_NAME:-pi0_gr2_black_capped_bottle_yellow_to_green}"
...
usage() {
  cat <<'EOF'
Usage:
  bash scripts/tools/train_pi0_gr2_black_capped_bottle_yellow_to_green.sh
